...
import (
	...
	"github.com/saveio/max/repo/common"
	config "github.com/saveio/max/repo/config"
	mfsr "github.com/saveio/max/repo/fsrepo/migrations"
	serialize "github.com/saveio/max/repo/fsrepo/serialize"
	dir "github.com/saveio/max/thirdparty/dir"

	"github.com/saveio/max/Godeps/_workspace/src/github.com/mitchellh/go-homedir"

	util "github.com/saveio/max/Godeps/_workspace/src/gx/ipfs/QmNiJuT8Ja3hMVpBHXv3Q6dwmperaQ6JjLtpMQgMCD7xvx/go-ipfs-util"
	lockfile "github.com/saveio/max/Godeps/_workspace/src/gx/ipfs/QmPdqSMmiwtQCBC515gFtMW2mP14HsfgnyQ2k5xPQVxMge/go-fs-lock"
	...
	measure "github.com/saveio/max/Godeps/_workspace/src/gx/ipfs/QmbJgZGRtkFeSdCxBCPaMKWRDYbqMxHyFfvjQGcWzpqsDe/go-ds-measure"
)
...
Please update ont-ipfs to a version that supports the existing repo, or run
...
func (err NoRepoError) Error() string {
	return fmt.Sprintf("no ONT-IPFS repo found in %s.\nplease run: 'ont-ipfs init'", err.Path)
}
...
// FSRepo represents an ONT-IPFS FileSystem Repo. It is safe for use by multiple
// callers.
type FSRepo struct {
...
func (r *FSRepo) GetStorageUsage() (uint64, error) {
	...
	*/
	pth, err := filepath.EvalSymlinks(r.path)
	if err != nil {
