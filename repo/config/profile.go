...
type Profile struct {
	...
	// Transform takes ont-ipfs configuration and applies the profile to it
...
running ONT-IPFS on machines with public IPv4 addresses.`,
...
profile, enables discovery in local networks.`,
	...
	"test": {
		Description: `Reduces external interference of ONT-IPFS daemon, this
...
If you apply this profile after ont-ipfs init, you will need
