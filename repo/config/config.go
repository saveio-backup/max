// package config implements the ont-ipfs config file datastructures and utilities.
package config
...
// Config is used to load ont-ipfs config files.
type Config struct {
