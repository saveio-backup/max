...
import (
	...
	"github.com/saveio/max/importer"
...
// gatewayHandler is a HTTP handler that serves ONT-IPFS objects (accessible by default at /ipfs/<path>)
...
func (i *gatewayHandler) getOrHeadHandler(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		webError(w, "invalid ont-ipfs path", err, http.StatusBadRequest)
		return
	}
	...
	// https://github.com/saveio/max/issues/1365
...
func (i *gatewayHandler) putHandler(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		webError(w, "putHandler: ONT-IPFS path not valid", err, http.StatusBadRequest)
		return
	}
