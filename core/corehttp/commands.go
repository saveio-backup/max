...
import (
	...
	corecommands "github.com/saveio/max/core/commands"
	...
	cmdsHttp "github.com/saveio/max/Godeps/_workspace/src/gx/ipfs/QmTjNRVt2fvaRFu93keEC7z5M1GS1iH6qZ9227htQioTUY/go-ipfs-cmds/http"
)
...
cli arguments:
	...
	ont-ipfs config API.HTTPHeaders 'Access-Control-Allow-Origin' '*'
	ont-ipfs daemon

or

	ont-ipfs daemon --api-http-header 'Access-Control-Allow-Origin: *'
`
...
// CheckVersionOption returns a ServeOption that checks whether the client ont-ipfs version matches. Does nothing when the user agent string does not contain `/go-ipfs/`
