...
import (
	...
	crypto "github.com/saveio/max/Godeps/_workspace/src/gx/ipfs/QmaPbCnUMBohSGo3KnxEa2bHqyJVVeEEcwtqJAYxerieBo/go-libp2p-crypto"
	"github.com/saveio/max/Godeps/_workspace/src/gx/ipfs/QmceUdzxkimdYsgtX733uNgzf1DLHyBKN6ehGSp85ayppM/go-ipfs-cmdkit"
)

var errNotOnline = errors.New("this command must be run in online mode. Try running 'ont-ipfs daemon' first")
...
You can use the 'ont-ipfs key' commands to list and generate more names and their
respective keys.

Examples:

Publish an <ont-ipfs-path> with your default name:

  > ont-ipfs name publish /ipfs/QmatmE9msSfkKxoffpHwNLNKgwZG8eT9Bud6YoPab52vpy
  Published to QmbCMUZw6JFeZ7Wp9jkzbye3Fzp2GGcPgC3nmeUjfVF87n: /ipfs/QmatmE9msSfkKxoffpHwNLNKgwZG8eT9Bud6YoPab52vpy

Publish an <ont-ipfs-path> with another name, added by an 'ont-ipfs key' command:

  > ont-ipfs key gen --type=rsa --size=2048 mykey
  > ont-ipfs name publish --key=mykey /ipfs/QmatmE9msSfkKxoffpHwNLNKgwZG8eT9Bud6YoPab52vpy
  Published to QmSrPmbaUKA3ZodhzPWZnpFgcPMFWF4QsxXbkWfEptTBJd: /ipfs/QmatmE9msSfkKxoffpHwNLNKgwZG8eT9Bud6YoPab52vpy

Alternatively, publish an <ont-ipfs-path> using a valid PeerID (as listed by 
'ont-ipfs key list -l'):

 > ont-ipfs name publish --key=QmbCMUZw6JFeZ7Wp9jkzbye3Fzp2GGcPgC3nmeUjfVF87n /ipfs/QmatmE9msSfkKxoffpHwNLNKgwZG8eT9Bud6YoPab52vpy
  Published to QmbCMUZw6JFeZ7Wp9jkzbye3Fzp2GGcPgC3nmeUjfVF87n: /ipfs/QmatmE9msSfkKxoffpHwNLNKgwZG8eT9Bud6YoPab52vpy
...
`,
	...
	Arguments: []cmdkit.Argument{
		cmdkit.StringArg("ipfs-path", true, false, "ont-ipfs path of the object to be published.").EnableStdin(),
	},
    ...
    "ns", "us" (or "µs"), "ms", "s", "m", "h".`).WithDefault("24h"),
		...
		cmdkit.StringOption("key", "k", "Name of the key to be used or a valid PeerID, as listed by 'ont-ipfs key list -l'. Default: <<default>>.").WithDefault("self"),
	},
