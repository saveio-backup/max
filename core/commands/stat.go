...
var StatsCmd = &cmds.Command{
	Helptext: cmdkit.HelpText{
		Tagline: "Query ONT-IPFS statistics.",
		ShortDescription: `'ipfs stats' is a set of commands to help look at statistics
for your ONT-IPFS node.
`,
...
var statBwCmd = &cmds.Command{
	Helptext: cmdkit.HelpText{
		Tagline: "Print ont-ipfs bandwidth information.",
		ShortDescription: `'ipfs stats bw' prints bandwidth information for the ont-ipfs daemon.
It displays: TotalIn, TotalOut, RateIn, RateOut.
		`,
		LongDescription: `'ipfs stats bw' prints bandwidth information for the ont-ipfs daemon.
It displays: TotalIn, TotalOut, RateIn, RateOut.
...
Example:
    ...
    > ont-ipfs stats bw -t /ipfs/bitswap
    Bandwidth
    TotalIn: 5.0MB
    TotalOut: 0B
    RateIn: 343B/s
    RateOut: 0B/s
    > ont-ipfs stats bw -p QmepgFW7BHEtU4pZJdxaNiv75mKLLRQnPi1KaaXmQN4V1a
    Bandwidth
    TotalIn: 4.9MB
    TotalOut: 12MB
    RateIn: 0B/s
