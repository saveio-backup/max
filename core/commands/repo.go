...
var RepoCmd = &cmds.Command{
	Helptext: cmdkit.HelpText{
		Tagline: "Manipulate the ONT_IPFS repo.",
		ShortDescription: `
'ont-ipfs repo' is a plumbing command used to manipulate the repo.
`,
	},
...
var repoGcCmd = &oldcmds.Command{
	Helptext: cmdkit.HelpText{
		...
		ShortDescription: `
'ont-ipfs repo gc' is a plumbing command that will sweep the local
...
var repoStatCmd = &cmds.Command{
	Helptext: cmdkit.HelpText{
		...
		ShortDescription: `
'ont-ipfs repo stat' is a plumbing command that will scan the local
...
var RepoFsckCmd = &oldcmds.Command{
	Helptext: cmdkit.HelpText{
		...
		ShortDescription: `
'ont-ipfs repo fsck' is a plumbing command that will remove repo and level db
...
var repoVersionCmd = &oldcmds.Command{
	Helptext: cmdkit.HelpText{
		...
		ShortDescription: `
'ont-ipfs repo version' returns the current repo version.
`,
	},
	...
	Marshalers: oldcmds.MarshalerMap{
		oldcmds.Text: func(res oldcmds.Response) (io.Reader, error) {
			...
			if quiet {
				...
				buf = bytes.NewBufferString(fmt.Sprintf("ont-ipfs repo version fs-repo@%s\n", response.Version))
			}
			return buf, nil
