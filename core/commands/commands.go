// Package commands implements the ont-ipfs command interface
//
// Using github.com/saveio/max/commands to define the command line and HTTP
// APIs.  This is the interface available to folks using ONT-IPFS from outside of
// the Go language.
package commands
