...
import (
	...
	coredag "github.com/saveio/max/core/coredag"
...
var DagCmd = &cmds.Command{
	Helptext: cmdkit.HelpText{
		...
		ShortDescription: `
'ont-ipfs dag' is used for creating and manipulating dag objects.

This subcommand is currently an experimental feature, but it is intended
to deprecate and replace the existing 'ont-ipfs object' command moving forward.
		`,
	},
...
var DagPutCmd = &cmds.Command{
	Helptext: cmdkit.HelpText{
		Tagline: "Add a dag node to ont-ipfs.",
		ShortDescription: `
'ont-ipfs dag put' accepts input from a file or stdin and parses it
...
var DagGetCmd = &cmds.Command{
	Helptext: cmdkit.HelpText{
		Tagline: "Get a dag node from ont-ipfs.",
		ShortDescription: `
'ont-ipfs dag get' fetches a dag node from ont-ipfs and prints it out in the specified
format.
`,
	},
	Arguments: []cmdkit.Argument{
...
var DagResolveCmd = &cmds.Command{
	Helptext: cmdkit.HelpText{
		...
		ShortDescription: `
'ont-ipfs dag resolve' fetches a dag node from ont-ipfs, prints it's address and remaining path.
`,
	},
	Arguments: []cmdkit.Argument{
