...
var SwarmCmd = &cmds.Command{
	Helptext: cmdkit.HelpText{
		...
		ShortDescription: `
'ont-ipfs swarm' is a tool to manipulate the network swarm. The swarm is the
component that opens, listens for, and maintains connections to other
ont-ipfs peers in the internet.
`,
	},
...
var swarmPeersCmd = &cmds.Command{
	Helptext: cmdkit.HelpText{
		...
		ShortDescription: `
'ont-ipfs swarm peers' lists the set of peers this node is connected to.
`,
	},
...
var swarmAddrsCmd = &cmds.Command{
	Helptext: cmdkit.HelpText{
		...
		ShortDescription: `
'ont-ipfs swarm addrs' lists all addresses this node is aware of.
`,
	},
	Subcommands: map[string]*cmds.Command{
...
var swarmAddrsLocalCmd = &cmds.Command{
	Helptext: cmdkit.HelpText{
		...
		ShortDescription: `
'ont-ipfs swarm addrs local' lists all local listening addresses announced to the network.
`,
	},
	Options: []cmdkit.Option{
...
var swarmAddrsListenCmd = &cmds.Command{
	Helptext: cmdkit.HelpText{
		...
		ShortDescription: `
'ont-ipfs swarm addrs listen' lists all interface addresses the node is listening on.
`,
	},
	Run: func(req cmds.Request, res cmds.Response) {
...
var swarmConnectCmd = &cmds.Command{
	Helptext: cmdkit.HelpText{
		...
		ShortDescription: `
'ont-ipfs swarm connect' opens a new direct connection to a peer address.

The address format is an ONT-IPFS multiaddr:

ont-ipfs swarm connect /ip4/104.131.131.82/tcp/4001/ipfs/QmaCpDMGvV2BGHeYERUEnRQAwe3N8SzbUtfsmvsqQLuvuJ
`,
	},
...
var swarmDisconnectCmd = &cmds.Command{
	Helptext: cmdkit.HelpText{
		...
		ShortDescription: `
'ont-ipfs swarm disconnect' closes a connection to a peer address. The address
format is an ONT-IPFS multiaddr:

ont-ipfs swarm disconnect /ip4/104.131.131.82/tcp/4001/ipfs/QmaCpDMGvV2BGHeYERUEnRQAwe3N8SzbUtfsmvsqQLuvuJ

The disconnect is not permanent; if ont-ipfs needs to talk to that address later,
it will reconnect.
`,
	},
	Arguments: []cmdkit.Argument{
...
var swarmFiltersCmd = &cmds.Command{
	Helptext: cmdkit.HelpText{
		...
		ShortDescription: `
'ont-ipfs swarm filters' will list out currently applied filters. Its subcommands
...
var swarmFiltersAddCmd = &cmds.Command{
	Helptext: cmdkit.HelpText{
		...
		ShortDescription: `
'ont-ipfs swarm filters add' will add an address filter to the daemons swarm.
Filters applied this way will not persist daemon reboots, to achieve that,
add your filters to the ont-ipfs config file.
`,
	},
	Arguments: []cmdkit.Argument{
...
var swarmFiltersRmCmd = &cmds.Command{
	Helptext: cmdkit.HelpText{
		...
		ShortDescription: `
'ont-ipfs swarm filters rm' will remove an address filter from the daemons swarm.
Filters removed this way will not persist daemon reboots, to achieve that,
remove your filters from the ont-ipfs config file.
`,
	},
	Arguments: []cmdkit.Argument{
