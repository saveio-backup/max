...
import (
	...
	util "github.com/saveio/max/blocks/blockstoreutil"
...
var BlockCmd = &cmds.Command{
	Helptext: cmdkit.HelpText{
		Tagline: "Interact with raw ONT-IPFS blocks.",
		ShortDescription: `
'ont-ipfs block' is a plumbing command used to manipulate raw ONT-IPFS blocks.
...
var blockStatCmd = &cmds.Command{
	Helptext: cmdkit.HelpText{
		Tagline: "Print information of a raw ONT-IPFS block.",
		ShortDescription: `
'ont-ipfs block stat' is a plumbing command for retrieving information
on raw ONT-IPFS blocks. It outputs the following to stdout:
...
var blockGetCmd = &cmds.Command{
	Helptext: cmdkit.HelpText{
		Tagline: "Get a raw ONT-IPFS block.",
		ShortDescription: `
'ont-ipfs block get' is a plumbing command for retrieving raw ONT-IPFS blocks.
...
var blockPutCmd = &cmds.Command{
	Helptext: cmdkit.HelpText{
		Tagline: "Store input as an ONT-IPFS block.",
		ShortDescription: `
'ont-ipfs block put' is a plumbing command for storing raw ONT-IPFS blocks.
...
`,
	...
	Arguments: []cmdkit.Argument{
		cmdkit.FileArg("data", true, false, "The data to be stored as an ONT-IPFS block.").EnableStdin(),
	},
...
var blockRmCmd = &cmds.Command{
	Helptext: cmdkit.HelpText{
		Tagline: "Remove ONT-IPFS block(s).",
		ShortDescription: `
'ont-ipfs block rm' is a plumbing command for removing raw ont-ipfs blocks.
