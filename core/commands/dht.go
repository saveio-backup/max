...
import (
	...
	ipdht "github.com/saveio/max/Godeps/_workspace/src/gx/ipfs/QmY1y2M1aCcVhy8UuTbZJBvuFbegZm47f9cDAdgxiehQfx/go-libp2p-kad-dht"
...
You may only use keytypes that are supported in your ont-ipfs binary: currently
this is only /ipns. Unless you have a relatively deep understanding of the
ont-ipfs DHT internals, you likely want to be using 'ont-ipfs name publish' instead
of this.
