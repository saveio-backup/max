...
import (
	...
	dag "github.com/saveio/max/core/commands/dag"
	e "github.com/saveio/max/core/commands/e"
	ocmd "github.com/saveio/max/core/commands/object"
	unixfs "github.com/saveio/max/core/commands/unixfs"
...
var Root = &cmds.Command{
	Helptext: cmdkit.HelpText{
		...
		Subcommands: `
BASIC COMMANDS
  init          Initialize ont-ipfs local configuration
  add <path>    Add a file to IPFS
  cat <ref>     Show ONT-IPFS object data
  get <ref>     Download ONT-IPFS objects
...
ADVANCED COMMANDS
  ...
  mount         Mount an ONT-IPFS read-only mountpoint
  resolve       Resolve any type of name
  name          Publish and resolve IPNS names
  key           Create and list IPNS name keypairs
  dns           Resolve DNS links
  pin           Pin objects to local storage
  repo          Manipulate the ONT-IPFS repository
  stats         Various operational stats
  p2p           Libp2p stream mounting
  filestore     Manage the filestore (experimental)

NETWORK COMMANDS
  id            Show info about ONT-IPFS peers
...
TOOL COMMANDS
  ...
  version       Show ont-ipfs version information
