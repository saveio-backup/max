...
const offlineIdErrorMessage = `'ont-ipfs id' currently cannot query information on remote
peers without a running daemon; we are working to fix this.
In the meantime, if you want to query remote peers using 'ont-ipfs id',
please run the daemon:

    ont-ipfs daemon &
    ont-ipfs id QmaCpDMGvV2BGHeYERUEnRQAwe3N8SzbUtfsmvsqQLuvuJ
`
...
var IDCmd = &cmds.Command{
	Helptext: cmdkit.HelpText{
		Tagline: "Show ont-ipfs node id info.",
		ShortDescription: `
Prints out information about the specified peer.
If no peer is specified, prints out information for local peers.

'ont-ipfs id' supports the format option for output with the following keys:
<id> : The peers id.
<aver>: Agent version.
...
EXAMPLE:
    ...
    ont-ipfs id Qmece2RkXhsKe5CRooNisBTh4SK119KrXXGmoK6V3kb8aH -f="<addrs>\n"
`,
	},
