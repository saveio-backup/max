...
import (
	...
	uarchive "github.com/saveio/max/unixfs/archive"
	...
	"github.com/saveio/max/Godeps/_workspace/src/gx/ipfs/QmeWjRodbcZFKe5tMN7poEx3izym6osrLSnTLf9UjJZBbs/pb"
)
...
var GetCmd = &cmds.Command{
	Helptext: cmdkit.HelpText{
		Tagline: "Download ONT-IPFS objects.",
		ShortDescription: `
Stores to disk the data contained an ONT-IPFS or IPNS object(s) at the given path.
...
`,
	...
	Arguments: []cmdkit.Argument{
		cmdkit.StringArg("ipfs-path", true, false, "The path to the ONT-IPFS object(s) to be outputted.").EnableStdin(),
	},
