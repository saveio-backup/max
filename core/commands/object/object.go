...
var ObjectCmd = &cmds.Command{
	Helptext: cmdkit.HelpText{
		Tagline: "Interact with ONT-IPFS objects.",
		ShortDescription: `
'ont-ipfs object' is a plumbing command used to manipulate DAG objects
directly.`,
	},
...
var ObjectDataCmd = &oldcmds.Command{
	Helptext: cmdkit.HelpText{
		Tagline: "Output the raw bytes of an ONT-IPFS object.",
		ShortDescription: `
'ont-ipfs object data' is a plumbing command for retrieving the raw bytes stored
...
var ObjectLinksCmd = &oldcmds.Command{
	Helptext: cmdkit.HelpText{
		...
		ShortDescription: `
'ont-ipfs object links' is a plumbing command for retrieving the links from
...
var ObjectGetCmd = &oldcmds.Command{
	Helptext: cmdkit.HelpText{
		...
		ShortDescription: `
'ont-ipfs object get' is a plumbing command for retrieving DAG nodes.
...
var ObjectStatCmd = &oldcmds.Command{
	Helptext: cmdkit.HelpText{
		...
		ShortDescription: `
'ont-ipfs object stat' is a plumbing command to print DAG node statistics.
...
var ObjectPutCmd = &oldcmds.Command{
	Helptext: cmdkit.HelpText{
		...
		ShortDescription: `
'ont-ipfs object put' is a plumbing command for storing DAG nodes.
...
Examples:
	...
	$ echo '{ "Data": "abc" }' | ont-ipfs object put
...
var ObjectNewCmd = &oldcmds.Command{
	Helptext: cmdkit.HelpText{
		Tagline: "Create a new object from an ont-ipfs template.",
		ShortDescription: `
'ont-ipfs object new' is a plumbing command for creating new DAG nodes.
`,
		LongDescription: `
'ont-ipfs object new' is a plumbing command for creating new DAG nodes.
...
// ErrEmptyNode is returned when the input to 'ont-ipfs object put' contains no data
