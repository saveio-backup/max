...
var ObjectPatchCmd = &cmds.Command{
	Helptext: cmdkit.HelpText{
		...
		ShortDescription: `
'ont-ipfs object patch <root> <cmd> <args>' is a plumbing command used to
...
Example:
	...
	$ echo "hello" | ont-ipfs object patch $HASH append-data
...
var patchSetDataCmd = &oldcmds.Command{
	Helptext: cmdkit.HelpText{
		Tagline: "Set the data field of an ONT-IPFS object.",
		ShortDescription: `
Set the data of an ONT-IPFS object from stdin or with the contents of a file.

Example:

    $ echo "my data" | ont-ipfs object patch $MYHASH set-data
`,
	},
	Arguments: []cmdkit.Argument{
		cmdkit.StringArg("root", true, false, "The hash of the node to modify."),
...
Example:
    ...
    $ EMPTY_DIR=$(ont-ipfs object new unixfs-dir)
    $ BAR=$(echo "bar" | ont-ipfs add -q)
    $ ont-ipfs object patch $EMPTY_DIR add-link foo $BAR
