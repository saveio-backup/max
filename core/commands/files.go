...
import (
	...
	bservice "github.com/saveio/max/blockservice"
	oldcmds "github.com/saveio/max/commands"
	lgc "github.com/saveio/max/commands/legacy"
...
// FilesCmd is the 'ont-ipfs files' command
var FilesCmd = &cmds.Command{
	Helptext: cmdkit.HelpText{
		Tagline: "Interact with unixfs files.",
		ShortDescription: `
Files is an API for manipulating ONT-IPFS objects as if they were a unix
filesystem.

NOTE:
Most of the subcommands of 'ont-ipfs files' accept the '--flush' flag. It defaults
to true. Use caution when setting this flag to false. It will improve
performance for large numbers of file operations, but it does so at the cost
of consistency guarantees. If the daemon is unexpectedly killed before running
'ont-ipfs files flush' on the files in question, then data may be lost. This also
applies to running 'ont-ipfs repo gc' concurrently with '--flush=false'
operations.
`,
	},
...
Examples:
    ...
    $ ont-ipfs files ls /welcome/docs/
    about
    contact
    help
    quick-start
    ...
    $ ont-ipfs files ls /myfiles/a/b/c/d
    foo
    bar
`,
	},
...
Examples:
    ...
    $ ont-ipfs files read /test/hello
    hello
        `,
	},
...
Example:
    ...
    $ ont-ipfs files mv /myfs/a/b/c /myfs/foo/newc
...
EXAMPLE:
    ...
    echo "hello world" | ont-ipfs files write --create /myfs/a/b/file
    echo "hello world" | ont-ipfs files write --truncate /myfs/a/b/file

WARNING:

Usage of the '--flush=false' option does not guarantee data durability until
the tree has been flushed. This can be accomplished by running 'ont-ipfs files
...
Examples:
    ...
    $ ont-ipfs files mkdir /test/newdir
    $ ont-ipfs files mkdir -p /test/does/not/exist/yet
`,
	},
...
Remove files or directories.
    ...
    $ ont-ipfs files rm /foo
    $ ont-ipfs files ls /bar
    cat
    dog
    fish
    $ ont-ipfs files rm -r /bar
`,
	},
