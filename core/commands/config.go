...
var ConfigCmd = &cmds.Command{
	Helptext: cmdkit.HelpText{
		Tagline: "Get and set ont-ipfs config values.",
		ShortDescription: `
'ont-ipfs config' controls configuration variables. It works like 'git config'.
The configuration values are stored in a config file inside your ont-ipfs
repository.`,
		LongDescription: `
'ont-ipfs config' controls configuration variables. It works
much like 'git config'. The configuration values are stored in a config
file inside your ONT-IPFS repository.

Examples:

Get the value of the 'Datastore.Path' key:

  $ ont-ipfs config Datastore.Path

Set the value of the 'Datastore.Path' key:

  $ ont-ipfs config Datastore.Path ~/.ont-ipfs/datastore
`,
	},
...
var configEditCmd = &cmds.Command{
	Helptext: cmdkit.HelpText{
		...
		ShortDescription: `
To use 'ont-ipfs config edit', you must have the $EDITOR environment
