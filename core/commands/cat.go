...
var CatCmd = &cmds.Command{
	Helptext: cmdkit.HelpText{
		Tagline:          "Show ONT_IPFS object data.",
		ShortDescription: "Displays the data contained by an ONT_IPFS or IPNS object(s) at the given path.",
	},

	Arguments: []cmdkit.Argument{
		cmdkit.StringArg("ipfs-path", true, true, "The path to the ONT_IPFS object(s) to be outputted.").EnableStdin(),
	},
