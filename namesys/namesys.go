...
// mpns (a multi-protocol NameSystem) implements generic ONT-IPFS naming.
//
// Uses several Resolvers:
// (a) ONT-IPFS routing naming: SFS-like PKI names.
// (b) dns domains: resolves using links in DNS TXT records
// (c) proquints: interprets string as the raw byte data.
//
// It can only publish to: (a) ONT-IPFS routing naming.
//
type mpns struct {
...
// NewNameSystem will construct the ONT-IPFS naming system based on Routing
