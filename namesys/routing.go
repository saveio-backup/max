...
// routingResolver implements NSResolver for the main ONT-IPFS SFS-like naming
...
// NewRoutingResolver constructs a name resolver using the ONT-IPFS Routing system
...
// resolveOnce implements resolver. Uses the ONT-IPFS routing system to
