...
import (
	...
	mp "github.com/saveio/max/Godeps/_workspace/src/gx/ipfs/QmUkfaKMw9rBRvYGrohn9HqYwZjzAasV4vM6bda8tiHCmq/go-multiplex" // Conn is a connection to a remote peer.
