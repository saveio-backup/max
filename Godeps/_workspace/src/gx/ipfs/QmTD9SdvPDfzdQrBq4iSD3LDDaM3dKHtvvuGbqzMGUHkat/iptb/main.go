...
import (
	...
	util "github.com/saveio/max/Godeps/_workspace/src/gx/ipfs/QmTD9SdvPDfzdQrBq4iSD3LDDaM3dKHtvvuGbqzMGUHkat/iptb/util"

	cli "github.com/saveio/max/Godeps/_workspace/src/gx/ipfs/QmVcLF2CgjQb5BWmYFWsDfxDjbzBfcChfdHRedxeL3dV4K/cli"
)
