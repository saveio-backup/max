...
import (
	...
	"github.com/saveio/max/Godeps/_workspace/src/gx/ipfs/QmYRGECuvQnRX73fcvPnGbYijBcGN2HbKZQ7jh26qmLiHG/semver"
)
...
For more help, see:
	...
	https://github.com/saveio/max/issues/177
`
...
You can also stop ont-ipfs from running these checks and use whatever OSXFUSE
version you have by running:

	ont-ipfs config %s true

[1]: https://github.com/saveio/max/issues/177
[2]: https://github.com/saveio/max/pull/533
[3]: %s
`
...
Just make sure the number is 2.7.2 or higher. You can then stop ont-ipfs from
...
Either way, please tell us at: http://github.com/saveio/max/issues
`
