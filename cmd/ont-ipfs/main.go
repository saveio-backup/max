// cmd/ipfs implements the primary CLI binary for ont-ipfs
package main
...
import (
	...
	coreCmds "github.com/saveio/max/core/commands"
	corehttp "github.com/saveio/max/core/corehttp"
	loader "github.com/saveio/max/plugin/loader"
	...
	"github.com/saveio/max/Godeps/_workspace/src/gx/ipfs/QmTjNRVt2fvaRFu93keEC7z5M1GS1iH6qZ9227htQioTUY/go-ipfs-cmds/http"
	ma "github.com/saveio/max/Godeps/_workspace/src/gx/ipfs/QmWWQ2Txc2c6tqjsBpzg5Ar652cHPGNsQQp2SejkNmkUMb/go-multiaddr"
	osh "github.com/saveio/max/Godeps/_workspace/src/gx/ipfs/QmXuBJ7DR6k3rmUEKtvVMhwjmXDuJgXXPUt4LQXKBMsU93/go-os-helper"
	loggables "github.com/saveio/max/Godeps/_workspace/src/gx/ipfs/Qmf9JgVLz46pxPXwG2eWSJpkqVCcjD4rp7zCRi2KP6GTNB/go-libp2p-loggables"
)
...
// command ought to be executed on an ont-ipfs daemon.
//
...
func commandShouldRunOnDaemon(details cmdDetails, req *cmds.Request, cctx *oldcmds.Context) (http.Client, error) {
	...
	if client != nil {
		if details.cannotRunOnDaemon {
			...
			if daemonLocked, _ := fsrepo.LockedByOtherProcess(cctx.ConfigRoot); daemonLocked {
				return nil, cmds.ClientError("ont-ipfs daemon is running. please stop it to run this command")
			}
			return nil, nil
		}
	...
	if details.cannotRunOnClient {
		return nil, cmds.ClientError("must run on the ont-ipfs daemon")
	}
...
var apiFileErrorFmt string = `Failed to parse '%[1]s/api' file.
	error: %[2]s
If you're sure ont-ipfs isn't running, you can just delete it.
`
var checkIPFSUnixFmt = "Otherwise check:\n\tps aux | grep ont-ipfs"
var checkIPFSWinFmt = "Otherwise check:\n\ttasklist | findstr ont-ipfs"
