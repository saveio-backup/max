// Package path contains utilities to work with ont-ipfs paths.
package path
...
// A Path represents an ont-ipfs content path:
//   * /<cid>/path/to/file
//   * /ipfs/<cid>
...
// ParsePath returns a well-formed ont-ipfs Path.
...
// ParseCidToPath takes a CID in string form and returns a valid ont-ipfs Path.
...
// IsValid checks if a path is a valid ont-ipfs Path.
