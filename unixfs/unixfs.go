// Package unixfs implements a data format for files in the ONT-IPFS filesystem It
// is not the only format in ont-ipfs, but it is the one that the filesystem
// assumes
package unixfs
