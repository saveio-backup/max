...
import (
	_ "github.com/saveio/max/Godeps/_workspace/src/github.com/jbenet/go-random"
	_ "github.com/saveio/max/Godeps/_workspace/src/github.com/jbenet/go-random-files"
)
